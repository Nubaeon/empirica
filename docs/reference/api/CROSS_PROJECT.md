...
**MCP parity (v1.9.4+):** the `mcp__empirica__finding_log` (and the other 5
...
flag and the v1.9.4 MCP parity work.
...
**Caveat (v1.9.4 state):** the original 1.7.0 design described a "cross-
