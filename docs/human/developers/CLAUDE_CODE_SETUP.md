...
The plugin (v1.5.4) now bundles everything in one package:
...
The plugin (v1.5.4) enforces the CASCADE workflow and preserves epistemic state automatically.
