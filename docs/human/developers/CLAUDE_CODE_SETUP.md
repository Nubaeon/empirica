...
The plugin (v1.6.1) now bundles everything in one package:
...
The plugin (v1.6.1) enforces the CASCADE workflow and preserves epistemic state automatically.
