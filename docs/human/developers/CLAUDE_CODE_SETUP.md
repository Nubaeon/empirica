...
The plugin (v1.5.7) now bundles everything in one package:
...
The plugin (v1.5.7) enforces the CASCADE workflow and preserves epistemic state automatically.
