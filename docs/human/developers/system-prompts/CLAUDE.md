...
**Model:** CLAUDE | **Syncs with:** Empirica v1.8.20
...
Edges and sources turn isolated artifacts into a navigable graph — the commit-context
walker only reaches what's anchored.
