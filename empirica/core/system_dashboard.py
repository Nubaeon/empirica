...
Subsystems monitored:
  ...
  MemoryGapDetector    - Integrity (gap count, confabulation risk)
...
- Pull: MCOLoader, Sentinel, MemoryGapDetector queried on get_system_status()
...
class IntegrityStatus:
    """MemoryGapDetector state snapshot."""
