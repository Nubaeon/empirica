...
_HELP_CATEGORIES = {
    ...
    'logging': ['finding-log', 'unknown-log', 'unknown-list', 'unknown-resolve', 'deadend-log', 'assumption-log', 'decision-log', 'mistake-log', 'mistake-query', 'source-add', 'source-list', 'sources-map', 'source-archive', 'act-log', 'investigate-log', 'log-artifacts', 'resolve-artifacts', 'delete-artifacts', 'epistemics-list', 'epistemics-show', 'noetic-batch'],
...
def main(args=None):
    ...
    try:
        command_handlers = {
            ...
            'entity-search': handle_entity_search_command,
            ...
            'goals-add-task': handle_goals_add_task_command,
            'goals-add-dependency': handle_goals_add_dependency_command,
            'goals-complete-task': handle_goals_complete_task_command,
            'goals-get-tasks': handle_goals_get_tasks_command,
            ...
            'goal-add-task': handle_goals_add_task_command,
            'goal-complete-task': handle_goals_complete_task_command,
            # Logging aliases
