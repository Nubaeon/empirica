...
def add_checkpoint_parsers(subparsers):
    ...
    project_search_parser.add_argument('--type', choices=['all', 'docs', 'memory', 'eidetic', 'episodic'], default='all', help='Result type: all, docs, memory, eidetic (facts), episodic (session arcs)')
