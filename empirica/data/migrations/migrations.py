...
ALL_MIGRATIONS: list[tuple[str, str, Callable]] = [
    ...
    ("043_goal_description", "Add description TEXT column to goals (Linear/GitHub/Jira pattern: title-shaped objective + optional rich body) — extension Claude flagged the title-vs-context-rich tension after the 1000→2000 mitigation in 1.9.5", lambda cursor: migration_043_goal_description(cursor)),
...
def migration_043_goal_description(cursor: sqlite3.Cursor):
    ...
    1.9.5 bumped 1000→2000 as short-term mitigation; this is the
