...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.11.1.tar.gz"
  sha256 "19012c8c8b4d09be021512a18ecf9a5642a495a18d8277b3f81f01360d02854f"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.11.1", shell_output("#{bin}/empirica --version")
