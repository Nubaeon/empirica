...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.13.39.tar.gz"
  sha256 "c0b470ccb39b3c1a961dcd7db3739e666dbc694285ca4980ea597c30e3bea056"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.13.39", shell_output("#{bin}/empirica --version")
