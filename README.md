...
[![Version](https://img.shields.io/badge/version-1.11.1-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.11.1)
...
docker pull nubaeon/empirica:1.11.1-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.11.1

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.11.1 /bin/bash
```
</details>
