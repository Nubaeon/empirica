...
[![Version](https://img.shields.io/badge/version-1.11.7-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.11.7)
...
docker pull nubaeon/empirica:1.11.7-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.11.7

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.11.7 /bin/bash
```
</details>
